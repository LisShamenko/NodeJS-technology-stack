...
import { NewModule1 } from './Modules/Module1';
let nm = new NewModule1();
nm.print();

// экспорт переменных
import { myVariable } from './Modules/Module1';
console.log(myVariable);

// более простой синтаксис экспорта по умолчанию
import Module2Default from './Modules/Module2';
...
function printWithModule(mod3: import("./Modules/Module3").Module3) {

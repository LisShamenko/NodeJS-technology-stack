...
- [CSS](#CSS)
    - [Запуск проекта](#Запуск-проекта-CSS)
    - [Основные файлы проекта](#Основные-файлы-проекта-CSS)
- [Angular](#Angular)
...
Каталог проекта: [~/AngularTechno/src/](https://github.com/LisShamenko/technology_NodeJS/tree/master/AngularTechno/src).
____
...
### Основные файлы проекта CSS

- **./AngularTechno/src/css**
    > Основной каталог, проект CSS находится в составе проекта Angular. Здесь определен модуль CSS, который содержит все компоненты css.
- **./AngularTechno/src/assets**
    > Содержит ресурсы используемые в таблицах стилей и html коде.
- **index.html**
    > Файл разметки в который добавляются теги компонентов css.
